--[[
  My custom CMDR gui, its a set container, that has follows modern react-style formating n stuff.
]]
...
return function()
	...
	AutocompleteStroke.Color = Color3.fromRGB(200, 40, 40)
	...
	-- Input bar — separated from Frame, parented directly to Cmdr
	local Entry = Instance.new("Frame")
	Entry.BackgroundColor3 = Color3.fromRGB(17, 17, 17)
	Entry.BackgroundTransparency = 0.4
	Entry.BorderSizePixel = 0
	Entry.LayoutOrder = 999999999
	Entry.Name = "Entry"
	Entry.Position = UDim2.new(0.025, 0, 0, 233)
	Entry.Size = UDim2.new(0.95, 0, 0, 32)
	Entry.Visible = false
	Entry.Parent = Cmdr
	...
	EntryStroke.Color = Color3.fromRGB(200, 40, 40)
